...
class TestAdapters(unittest.TestCase):
    ...
    def test_real_thronos_attestation_adapter_injects_authorization_bearer_header(self):
        captured: dict[str, object] = {}
        ...
        a = RealThronosAttestationAdapter(
            ...
            submit_auth_header_ref="ref://token-value",
            submit_auth_header_prefix="Bearer",
            submit_post_fn=_submit,
        )
        a.submit_attestation(self._payload(target_backend_type="thronos_network", target_network="thronos-mainnet"))
        headers = captured["headers"]
        self.assertEqual(headers["Authorization"], "Bearer ref://token-value")

    def test_real_thronos_attestation_adapter_injects_custom_auth_header(self):
        captured: dict[str, object] = {}
        ...
        a = RealThronosAttestationAdapter(
            ...
            network="thronos-mainnet",
            exec_enabled=True,
            submit_auth_header_name="X-Internal-Key",
            submit_auth_header_ref="ref://internal-key",
            submit_post_fn=_submit,
        )
        a.submit_attestation(self._payload(target_backend_type="thronos_network", target_network="thronos-mainnet"))
        headers = captured["headers"]
